  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const lambdaLayer = new LayerVersion(this, 'RequestsLayer', {
      code: Code.fromBucket(Bucket.fromBucketName(this, 'LayerBucket',
        'cdk-project-lambda-layer-zip-files-1'), //TODO: replace 'cdk-project-lambda-layer-zip-files-1' with your bucket name
    ...
    const sesLambdaFunction = new Function(this, 'SesLambdaFunction', {
      ...
      environment: {
        SES_SOURCE_EMAIL: 'chendong427161@gmail.com', //TODO: replace with your SES verified email
        SES_DESTINATION_EMAIL: 'chendong427161@gmail.com' //TODO: replace with your destination email
      }
    });
