...
export class LeetCodeProgressEmailTrackerStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    lambdaRole.addToPolicy(
      new PolicyStatement({
        ...
        resources: ['arn:aws:s3:::lambda-output-bucket-533267129974-us-east-2'], //TODO: change your AWS accountID and region
      }),
    );
    lambdaRole.addToPolicy(
      new PolicyStatement({
    ...
    const lambdaLayer = new LayerVersion(this, 'RequestsLayer', {
      code: Code.fromBucket(Bucket.fromBucketName(this, 'LayerBucket',
        'cdkprojectlambdalayer'), //TODO: replace 'cdk-project-lambda-layer-zip-files-1' with your bucket name
    ...
    const sesLambdaFunction = new Function(this, 'SesLambdaFunction', {
      ...
      environment: {
        SES_SOURCE_EMAIL: 'muyunji2023@gmail.com', //TODO: replace with your SES verified email
        SES_DESTINATION_EMAIL: 'muyunji2023@gmail.com' //TODO: replace with your destination email
      }
    });
